// Note: This has been upgraded for jQuery 3.1
// 'size()' functions have been changed to 'length'
// Ray Ives on 2017/07/11
//
            ...
            $this.change(function() {
                ...
                rows.each(function() {
                    ...
                    if (filter) {
                        ...
                        if ($.trim(cell.text().toLowerCase()).indexOf($.trim(filter.toLowerCase())) !== -1 ) {
