    ...
    <div class="container-fluid">
        ...
        {{-- content ----------------------------------------------------------------------------------------}}
            ...
            <section class="col-md col-12 pa-1 mb-4 content" id="content">
                <div class="row">
                    <div class="col-md">
                        <h3 class="page-header">Manage Schools</h3>
                    </div>
        ...
        {{-- search ----------------------------------------------------------------------------------------}}
                ...
                <h5 class="mt-4">Find a School</h5>
                <p class="text-muted ml-3">Enter any part of a school's name, suburb or city.</p>
                <div class="row">
                    ...
                    <div class="col-md-10 col-xl-6">
                        <div id="showsearch" class="card ml-3 mt-4" style="display:none">
                            <div class="card-header">
                                ...
                                <small class="card-text text-muted">Click on the School to open/edit the profile.</small>
                            </div>
        ...
        {{-- add school ----------------------------------------------------------------------------------------}}
                ...
                <h5 class="mt-5">
                    <a class="btn btn-outline-dark" href="{!! url('office/schools/create') !!}">Add a New School</a>
                </h5>
            </section>
        </div>
    </div>
